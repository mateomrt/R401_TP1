...
namespace WSConvertisseur.Controllers.Tests
{
    ...
    public class DevisesControllerTests
    {
        ...
        public void GetById_UnknownGuidPassed_ReturnsNotFoundResult()
        {
            ...
            DevisesController controller = new DevisesController();
            // Act
            var resultUnknown = controller.GetById(4);
            // Assert
            Assert.IsInstanceOfType(resultUnknown, typeof(ActionResult<Devise>), "Pas un ActionResult"); // Test du type de retour
            Assert.IsInstanceOfType(resultUnknown.Result, typeof(NotFoundResult), "Pas un ActionResult");
            Assert.IsNull(resultUnknown.Value, "Erreur est pas null"); //Test de l'erreur
        }
    }
}